...
// Версия: 3.3 (ОБНОВЛЕНА ИНИЦИАЛИЗАЦИЯ ОНБОРДИНГА)
// ============================================================
...
(function() {
    ...
    function initializeApp() {
        ...
        try {
            ...
            // Onboarding.init() вызывается автоматически при загрузке файла onboarding.js
            // Здесь мы НЕ вызываем Onboarding.init(), чтобы избежать дублирования
            // Onboarding.checkAndAutoStart() будет вызван из User.save() после создания пользователя
            console.log('[App] Онбординг инициализируется через onboarding.js');
    ...
    function loadDataAndRender() {
        ...
        Promise.all([jksPromise, questionsPromise, scenariosPromise])
            ...
            .then(function(result) {
                ...
                // ===== ИНИЦИАЛИЗАЦИЯ ОНБОРДИНГА (FALLBACK) =====
                // Onboarding.init() вызывается автоматически в onboarding.js
                // Здесь мы НЕ вызываем Onboarding.init(), чтобы избежать дублирования
                console.log('[App] Онбординг инициализируется через onboarding.js');
    ...
    console.log('[App] Модуль загружен, версия: 3.3');
