...
const urlsToCache = [
  ...
  './js/steps/stepRegistry.js',
  './js/steps/stepRegistry-init.js',
  './js/steps/quiz.js',
  './js/steps/brief.js',
  './js/steps/interactive-lesson1.js',
  './js/steps/interactive.js',
  './js/steps/client-journey.js',
  './js/game/timer-quiz.js',
  './js/game/decision-chain.js',
  './js/game/triple-match-drag.js',
  './js/ui/ui.js',
  './js/ui/drawer.js',
  './js/ui/onboarding.js',
  './js/ui/premium-ui.js',
  './js/ui/landing-animations.js',
  './js/privacy/consent.js',
  './js/privacy/consent-banner.js',
  './js/privacy/privacy-manager.js',
  './js/map/map-core.js',
  './js/map/map-utils.js',
  './js/map/map-ui.js',
  './js/map/map-step.js',
  './js/core/app-analytics.js',
  './js/core/app-offline.js',
  './js/core/app-pwa.js',
  './js/core/app-autosave.js',
  './js/core/app-events.js',
  './js/core/app-initializer.js',
  './js/core/app-scenario.js',
  ...
  './js/developer/materials.js',
  './js/developer/construction.js',
  './js/developer/selling.js',
  './js/developer/developer-core.js',
  './js/developer/developer-ui.js',
  './js/developer/developer-stages.js',
  './js/developer/developer-admin.js',
  './js/developer/developer.js',
  './js/consultation/consultation-core.js',
  './js/consultation/consultation-ui.js',
  './js/consultation/consultation-dialog.js',
  './js/consultation/consultation-main.js',
  './manifest.json'
];
